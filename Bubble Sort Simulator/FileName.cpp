...
void draw()
{
    ...
    else if (whichwindow == 1)
    {
        ...
        std::string instructions = "Enter numbers and press Enter to store. Backspace to delete.";
    ...
    else if (whichwindow == 3)
    {
        ...
        drawText("Name", -0.5, 0.7);
        drawText("USN", 0.1, 0.7);

        drawText("Abdul Rab", -0.5, 0.5);
        drawText("1AT20CS002", 0.1, 0.5);

        drawText("Aryaman Datta", -0.5, 0.3);
        drawText("1AT20CS011", 0.1, 0.3);

        drawText("Hajira Zuha", -0.5, 0.1);
        drawText("1AT20CS036", 0.1, 0.1);

        drawText("Joel Pinto", -0.5, -0.1);
        drawText("1AT20CS122", 0.1, -0.1);

        drawText("Chandana D", -0.5, -0.3);
        drawText("1AT20CS403", 0.1, -0.3);
    ...
    {
        const wchar_t* exePath = L"OpenGL6.exe";
